...
def load_data_from_api(*args, **kwargs):
    ...
    entity = kwargs.get('entity', 'items').lower()
    entity_qbo = ENTITY_MAP.get(entity, 'Item')
    ...
    # Segmentación semanal (para mantener consistencia, aunque Items cambian poco)
